	...
	private void processSkeleton () {
		...
		for (int player = 0; player < 2; player++)
		{
			if (trackedPlayers[player] >= 0)
			{
                ...
                //update hand state
                handState[player, 0] = kinect.getIsLeftHandGrip(trackedPlayers[player]);
                handState[player, 1] = kinect.getIsRightHandGrip(trackedPlayers[player]);
            }
		}
	}
}
